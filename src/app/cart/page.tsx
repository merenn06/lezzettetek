                    ...
                    >
                      {(item.imageUrl || (item.product as any).image_url) ? (
                        <div className="w-full h-full rounded-lg overflow-hidden border border-gray-200 bg-white">
                          ...
                          <img
                            src={item.imageUrl || (item.product as any).image_url}
                            alt={item.product.name}
                            className="w-full h-full object-cover"
                          />
                        </div>
                      ) : (
                        <div className="w-full h-full bg-gradient-to-br from-green-200 to-green-400 rounded-lg flex items-center justify-center">
                          <svg
